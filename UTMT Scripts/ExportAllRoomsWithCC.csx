...
SetProgressBar(null, "Exporting rooms...", 0, Data.Rooms.Count);
...
void DumpCode(UndertaleCode code)
{
    ...
    if (code.ParentEntry == null)
    {
        try
        {
            File.WriteAllText(path, (code != null ? new DecompileContext(decompileContext, code, Data.ToolInfo.DecompilerSettings).DecompileToString() 
 : ""));
        }
        catch (Exception e)
        {
