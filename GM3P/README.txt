...
Section 1: Operation Instructions
	...
	Part 1.1: Console
		...
		1.1.11 Once you hit enter again, the program will delete output\xDeltaCombiner and close. You may close via Alt+F4, Ctrl+C, or hitting the "X" on the window if you don't want to delete them, but you will need to manually delete the folder on next use. 
	Part 1.2: Available CLI commands
		...
		config - updates and saves configuration

Section 2: Technical Information
	Part 2.1: System Requirements
		2.1.2: System Requirements
			OS: Windows 10 build 1809 or later; Debian-based or Azure Linux
		...
		2.1.3: System Recommended
			OS: Windows 11 build 23H2 or 24H2
			CPU: Intel i5-2400 or later
			Storage: 2GB NvME SSD
			RAM: 2GB
			Software: Git (Windows and Linux)
	...
	Part 2.3: Known Issues and limitations
		Issue: Textures may not be imported with the right width or height, affecting hitboxes.
	...
	Part 2.4: Tools used
		...
		The CLI version of UndertaleModTool for dumping and importing GameMaker Objects
	...
	Part 2.5 Life Cycle Policy:
		...
		There are 2 exceptions to this policy: v0.1.0 and the DeltaMOD Mod Manager v1.x
		...
		For DeltaMOD, support is for whatever the latest version of GM3P that's compatible with whatever is the latest version of DeltaMOD v1. 
